...
class PatchManagerApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Label(header, text="⚔  Project Reforged", bg="#161b22",
                 fg="#e6edf3", font=("Segoe UI", 14, "bold")).pack(side="left", padx=16, pady=12)
        tk.Label(header, text=f"Patch Manager v{APP_VERSION}", bg="#161b22",
